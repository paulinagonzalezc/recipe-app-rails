...
```sh
  cd my-folder
  git clone  https://github.com/paulinagonzalezc/recipe-app-rails
```
...
Feel free to check the [issues page](https://github.com/paulinagonzalezc/recipe-app-rails/issues).
